...
/*   Updated: 2022/10/20 14:19:41 by leng-chu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	adjust_object(unsigned int key, t_app *app)
{
	...
	if (key == KEY_I || key == KEY_O)
		object->coor.z += pow(-1, key != KEY_I) * 0.1f;
	else if (key == KEY_UP || key == KEY_DOWN)
		object->coor.y += pow(-1, key != KEY_UP) * 0.1f;
	else if (key == KEY_RIGHT || key == KEY_LEFT)
		object->coor.x += pow(-1, key != KEY_RIGHT) * 0.1f;
